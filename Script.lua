...
if getgenv().Host == game.Players.LocalPlayer.Name then
	getgenv().ExecutedAlt = true
	loadstring(game:HttpGet("https://raw.githubusercontent.com/GhoulScript/NovaZ/main/SellingTools"))()
	return
end
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/GhoulScript/AntiCheat/main/Bypass.lua"))()
...
function Abbreviate(value)
	...
	if value  < cut then
		...
		if div > #abbreviations  then
			print("div", div, "shit", #abbreviations )
			str = inStr
		else
			if rem == 1 then
...
if getgenv().Render == true then
	...
	TextLabel.Text = "Welcome To Nova Z ALT CONTROL "..game.Players.LocalPlayer.Name.." "
...
repeat wait(1) until game.Players:FindFirstChild(getgenv().Host)
local MainAccount = getgenv().Host
...
if Player then
	...
	local function SetupTrain()
		...
		local TargCF = CFrame.new(115.562843, 11.9748383, 140.877167, 0.999986827, 4.5340498e-10, 0.00513085537, -4.82861529e-10, 1, 5.73982595e-09, -0.00513085537, -5.74222803e-09, 0.999986827)
	...
	local function SetUpClub()
		...
		local TargCF = CFrame.new(503.220917, 75.0852432, -914.891785, -0.00599479768, 6.79581831e-08, -0.999982059, 6.27830943e-08, 1, 6.75830236e-08, 0.999982059, -6.23768202e-08, -0.00599479768)
		--Player.Character.HumanoidRootPart.CFrame = TargCF
		for i = 1,10 do
			if PointInTable == i then
				local TargCF = CFrame.new(503.220917, 75.0852432, -914.891785, -0.00599479768, 6.79581831e-08, -0.999982059, 6.27830943e-08, 1, 6.75830236e-08, 0.999982059, -6.23768202e-08, -0.00599479768)
	...
	local function SetUpBank()
		...
		for i = 1,10 do
			if PointInTable == i then
				...
				local TargCF = CFrame.new(-381.916168, 21.2575245, -339.244354, 0.999603212, -3.31033405e-08, 0.0281667896, 3.41281172e-08, 1, -3.59017278e-08, -0.0281667896, 3.6848764e-08, 0.999603212)*CFrame.new(0,0,-3)
	...
	local function SetUpAdmin2()
		...
		local TargCF = CFrame.new(-1011.31689, -51.1466827, -1025.17041, 0.0356113464, -9.92241933e-09, 0.999365687, 1.15309334e-07, 1, 5.81978998e-09, -0.999365687, 1.15028939e-07, 0.0356113464)
		--Player.Character.HumanoidRootPart.CFrame = TargCF
		for i = 1,10 do
			if PointInTable == i then
				local TargCF = CFrame.new(-1011.31689, -51.1466827, -1025.17041, 0.0356113464, -9.92241933e-09, 0.999365687, 1.15309334e-07, 1, 5.81978998e-09, -0.999365687, 1.15028939e-07, 0.0356113464)
	...
	local function SetUpAdmin() 
		...
		for i = 1,10 do
			if PointInTable == i then
				...
				local TargCF = 	CFrame.new(-863.872498, -38.3916817, -612.267944, 0.999988735, -4.30345075e-08, -0.00474801101, 4.33000693e-08, 1, 5.58278082e-08, 0.00474801101, -5.60327678e-08, 0.999988735)
		...
		for index = 21,30 do
			i += 1
			if PointInTable == index then
				local XCoordinate = 18
				local ZCoordinate = 10
				ZCoordinate = i*7
		...
		Player.Chatted:Connect(function(Chat)
			...
			if game.Players.LocalPlayer.Character and game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart") and game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") and game.Players.LocalPlayer.Character.Humanoid.Health > 0 then
				if Player.Character and Player.Character:FindFirstChild("HumanoidRootPart")  and Player.Character:FindFirstChild("Humanoid") and Player.Character.Humanoid.Health > 0 then
					...
					elseif Chat == ".bring host admin2" then

						BringPlr(Player.Name,CFrame.new(-1011.31689, -51.1466827, -1025.17041, 0.0356113464, -9.92241933e-09, 0.999365687, 1.15309334e-07, 1, 5.81978998e-09, -0.999365687, 1.15028939e-07, 0.0356113464))

					elseif Chat == ".LLs" then
					...
					elseif Chat == ".Wwhy" then
						...
						--end of bring host locations
						
						elseif Chat == ".block" then -- block alts
					...
					elseif Chat == ".unblock" then -- unblock alts
					...
					elseif Chat == ".dance1" then
						...
						CurrAnim:Play()
						CurrAnim:AdjustSpeed()
					elseif Chat == ".undance" then
						if CurrAnim and CurrAnim.IsPlaying then
							CurrAnim:Stop()
						end
					elseif Chat == ".dance2" then
						if CurrAnim and CurrAnim.IsPlaying then
							CurrAnim:Stop()
						end
						local Anim = Instance.new("Animation")
					...
					elseif Chat == ".airlock" then
						...
						game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = 	game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame*CFrame.new(0,6,0)
					...
					elseif Chat == ".bring host sz3" then
						BringPlr(Player.Name,CFrame.new(115.562843, 11.9748383, 140.877167, 0.999986827, 4.5340498e-10, 0.00513085537, -4.82861529e-10, 1, 5.73982595e-09, -0.00513085537, -5.74222803e-09, 0.999986827))

					elseif Chat == ".advert off" then
						AddOn = false
					elseif Chat ~= ".advert off" and Chat:match(".advert on") and AddOn == false then



						local newStr, replaced = string.gsub(Chat, ".advert on", "")
